...
AnimationStudent::AnimationStudent(const std::string& name, int x, int y, int width, int height)
...
AnimationStudent::~AnimationStudent() {
...
SDL_Texture* AnimationStudent::loadTexture(const std::string& path) {
